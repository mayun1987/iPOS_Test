 ...
 * @Version V1.0
 */
public class AuthPayControllerDemo_D extends DemoParams {
    ...
    public static final String outTradeNo   = "201905090000000010";  //【必填】请求交易号，唯一交易标识
    public static final long   tradeAmount  = 100L;                  //【必填】交易金额单位：分
    public static final String bankCode     = "CCB";                 //【必填】银行编码  建行CCB 工商ICBC 农行ABC
    public static final int    cardType     = 3;                     //【必填】银行卡类型 1：借记卡，2：贷记卡 DC: "储蓄卡",CC: "信用卡",SCC: "准贷记卡",PC: "预付费卡
    public static final String cardNo       = "6253624002979099";    //【必填】银行卡号  y贷记卡6253624002979092
    public static final String cardExp      = "2313";                //卡有效期 格式：YYMM 贷记卡必填 02/24
    public static final String cardCvv      = "123";                 //卡CVN2             贷记卡必填 235
    public static final String holderName   = "王五";                //【必填】持卡人姓名
    public static final String holderIdType = "IDCARD";              //【必填】持卡人证件类型
    public static final String holderIdNo   = "1102291999090109999";  //【必填】持卡人证件号 110100198708010088
    ...
    public static final String verifyCode    = "100555";                 //【必填】认证申请时发送的短信验证码

    public static final String outOrderNo   = "201905090000000008";    //【必填】外部订单号,代理商带进来的订单号  与认证、确认支付的不一致out_order_no
    public static final String orderNo      = "201905090000000222";    //【必填】订单编号                  这个是业务自己生成的订单号order_no
    public static final long   txAmt        = 1L;                      //【必填】提现金额
    public static final String cardNo_D     = "6217000010043148888";   //【必填】银行卡号
